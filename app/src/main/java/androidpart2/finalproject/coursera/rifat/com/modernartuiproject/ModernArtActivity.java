package androidpart2.finalproject.coursera.rifat.com.modernartuiproject;
...
public class ModernArtActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout magentaBox = (LinearLayout) findViewById(R.id.magentaBox);
        ...
        final LinearLayout cyanBox = (LinearLayout) findViewById(R.id.cyanBoxBottom);
        ...
        final int originalMagenta = ((ColorDrawable) magentaBox.getBackground()).getColor();
        ...
        colorControl.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                setProgressBasedBackgroundColor(magentaBox, originalMagenta);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_more_information) {
            DialogFragment moreInfoFragment = new ModernArtActivityFragment();
